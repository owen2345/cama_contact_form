...
def create_form
  ...
  # The create posts over AJAX and swaps the editor into #admin_content. Wait for that to finish
  # before returning, so an in-flight response can't overwrite the page a caller navigates to next.
